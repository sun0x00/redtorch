...
class MdSpi internal constructor(private val ctpGatewayImpl: CtpGatewayImpl) : CThostFtdcMdSpi() {
    ...
    fun connect() {
        ...
        val tempFilePath =
            "${envTmpDir}${separator}xyz${separator}redtorch${separator}gateway${separator}ctp${separator}jctpv6v5v1cpx64api${separator}CTP_FLOW_TEMP${separator}MD_${gatewayId}"
