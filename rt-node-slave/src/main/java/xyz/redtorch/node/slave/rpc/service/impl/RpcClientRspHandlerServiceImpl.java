...
public class RpcClientRspHandlerServiceImpl implements RpcClientRspHandlerService {
	...
	private Logger logger = LoggerFactory.getLogger(RpcClientRspHandlerServiceImpl.class);

	private Map<String, RpcSyncSlaveNodeRuntimeDataRsp> rpcSyncSlaveNodeRuntimeDataRspMap = new ConcurrentHashMap<>(
			100000);
