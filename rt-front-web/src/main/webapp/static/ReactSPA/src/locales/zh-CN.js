export default {
  'validation.trade.fuzzySymbol.required': '请输入代码',
  'form.trade.fuzzySymbol.label': '代码',
  'form.trade.fuzzySymbol.placeholder': '支持模糊查询',
  'validation.trade.direction.required': '请选择方向',
  'form.trade.direction.label':"方向",
  'form.trade.direction.long':'多',
  'form.trade.direction.short':'空',
  'validation.trade.offset.required': '请选择开平',
  'form.trade.offset.label': '开平',
  'form.trade.offset.open':'开仓',
  'form.trade.offset.close':'平仓',
  'form.trade.offset.closeToday':'平今',
  'form.trade.offset.closeYesterday':'平昨',
  'form.trade.price.label': '价格',
  'validation.trade.volume.required': '请填写委托量',
  'form.trade.volume.label': '委托量',
  'validation.trade.priceType.required': '请选择价格类型',
  'form.trade.priceType.label': '价格类型',
  'form.trade.priceType.fak': 'FAK',
  'form.trade.priceType.fok': 'FOK',
  'form.trade.priceType.limit': '限价',
  'form.trade.priceType.market': '市价',
  'form.trade.exchange.placeholder': '请选择交易所',
  'form.trade.exchange.label': '交易所',
  'form.trade.currency.placeholder': '请选择货币',
  'form.trade.currency.label': '货币',
  'form.trade.product.placeholder': '请选择产品类型',
  'form.trade.product.label': '产品类型',
  'form.trade.gateway.placeholder': '请选择网关',
  'form.trade.gateway.label': '网关',
  'validation.trade.gateway.required': '请选择网关',
  'form.trade.action.sendOrder': '发单',
  'form.trade.action.resetForm': '重置',
  'form.trade.action.cancelAll': '全撤',
  'form.trade.priceAutoComplete.label':'价格自动填充',
  'form.trade.priceAutoComplete.manual':'手动',
  'form.trade.priceAutoComplete.lastPrice':'最新价',
  'form.trade.priceAutoComplete.active':'主动价',
  'form.trade.priceAutoComplete.queue':'排队价',
  ...
  'menu.trade': '交易',
  'menu.trade.basic': '基本交易',
  'menu.trade.multiAccount': '多账户交易',
  'menu.home': '首页',
  'menu.strategy': '策略',
  'menu.strategy.zeus': 'ZEUS',
  'menu.gateway': '网关',
  'menu.dataRecord': '行情记录',
  'menu.riskControl': '风险控制',
  'menu.log': '日志',
