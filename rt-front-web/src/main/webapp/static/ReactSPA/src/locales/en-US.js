export default {
  'validation.trade.fuzzySymbol.required': 'Please enter a symbol',
  'form.trade.fuzzySymbol.label': 'Symbol',
  'form.trade.fuzzySymbol.placeholder': 'Support Fuzzy Query',
  'validation.trade.direction.required': 'Please select the direction',
  'form.trade.direction.label':'Direction',
  'form.trade.direction.long':'Long',
  'form.trade.direction.short':'Short',
  'validation.trade.offset.required': 'Please select the offset',
  'form.trade.offset.label': 'Offset',
  'form.trade.offset.open':'Open',
  'form.trade.offset.close':'Close',
  'form.trade.offset.closeToday':'Close Today',
  'form.trade.offset.closeYesterday':'Close Yesterday',
  'form.trade.price.label': 'Price',
  'validation.trade.volume.required': 'Please enter order volume',
  'form.trade.volume.label': 'Volume',
  'validation.trade.priceType.required': 'Please select the price type',
  'form.trade.priceType.label': 'PriceType',
  'form.trade.priceType.fak': 'FAK',
  'form.trade.priceType.fok': 'FOK',
  'form.trade.priceType.limit': 'Limit',
  'form.trade.priceType.market': 'Market',
  'form.trade.exchange.placeholder': 'Plese select a exchange',
  'form.trade.exchange.label': 'Exchange',
  'form.trade.currency.placeholder': 'Plese select a currency',
  'form.trade.currency.label': 'Currency',
  'form.trade.product.placeholder': 'Plese select a product class',
  'form.trade.product.label': 'Product Class',
  'form.trade.gateway.placeholder': 'Plese select the gateway',
  'form.trade.gateway.label': 'Gateway',
  'form.trade.action.sendOrder': 'Send',
  'form.trade.action.resetForm': 'Reset',
  'form.trade.action.cancelAll': 'Cancel All',
  'validation.trade.gateway.required': 'Plese select the gateway',
  'form.trade.priceAutoComplete.label':'Price Auto Complete',
  'form.trade.priceAutoComplete.manual':'Manual',
  'form.trade.priceAutoComplete.lastPrice':'LastPrice',
  'form.trade.priceAutoComplete.active':'Active',
  'form.trade.priceAutoComplete.queue':'Queue',
  ...
  'project.desc':"A sample to use the Java framework for a trading application",
  ...
  'menu.trade': 'Trade',
  'menu.trade.basic': 'SimpleTrade',
  'menu.trade.multiAccount': 'Multi-Account',
  'menu.list': 'List',
