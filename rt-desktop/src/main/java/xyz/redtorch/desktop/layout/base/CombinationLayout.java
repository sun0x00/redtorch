...
public class CombinationLayout {
    ...
    private final Text allTodayProfitText = new Text("N/A");
    private final Text allBalanceText = new Text("N/A");
    private final Text allOpenPositionProfitText = new Text("N/A");
    private final Text allPositionProfitText = new Text("N/A");
    private final Text allMarginText = new Text("N/A");
    private final Text allCommissionText = new Text("N/A");
    private final Text allCloseProfitText = new Text("N/A");
    private final Text allContractValueText = new Text("N/A");
    private final Text allDepositAndWithdrawText = new Text("N/A");
    ...
    public void render() {
        ...
        if (allMargin != null && allBalance != 0) {
