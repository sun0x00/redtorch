...
public class DesktopTradeCachesServiceImpl implements DesktopTradeCachesService, InitializingBean {
    ...
    private final Map<String, TradeField> tradeMap = new HashMap<>(100000);
    private final Map<String, AccountField> accountMap = new HashMap<>(500);
    private final Map<String, PositionField> positionMap = new HashMap<>(5000);
    ...
    public List<TickField> getMixTickList() {
        ...
        contractMapLock.lock();
        try {
            contractList = new ArrayList<>(mixTickMap.values());
        } catch (Exception e) {
