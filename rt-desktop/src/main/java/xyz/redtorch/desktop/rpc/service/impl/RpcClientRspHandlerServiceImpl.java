...
public class RpcClientRspHandlerServiceImpl implements RpcClientRspHandlerService {
	...
	private Map<String, RpcGetMixContractListRsp> rpcGetMixContractListRspMap = new ConcurrentHashMap<>(100000);
	...
	private Map<String, RpcQueryDBBarListRsp> rpcQueryDBBarListRspMap = new ConcurrentHashMap<>(100000);
	private Map<String, RpcQueryDBTickListRsp> rpcQueryDBTickListRspMap = new ConcurrentHashMap<>(100000);
	private Map<String, RpcQueryVolumeBarListRsp> rpcQueryVolumeBarListRspMap = new ConcurrentHashMap<>(100000);
	...
	@Override
	public RpcQueryDBBarListRsp getAndRemoveRpcQueryDBBarListRsp(String reqId) {
		RpcQueryDBBarListRsp rpcQueryDBBarListRsp = rpcQueryDBBarListRspMap.remove(reqId);
	...
	@Override
	public RpcQueryDBTickListRsp getAndRemoveRpcQueryDBTickListRsp(String reqId) {
		RpcQueryDBTickListRsp rpcQueryDBTickListRsp = rpcQueryDBTickListRspMap.remove(reqId);
	...
	@Override
	public RpcQueryVolumeBarListRsp getAndRemoveRpcQueryVolumeBarListRsp(String reqId) {
		RpcQueryVolumeBarListRsp rpcQueryVolumeBarListRsp = rpcQueryVolumeBarListRspMap.remove(reqId);
	...
	@Override
	public RpcGetMixContractListRsp getAndRemoveRpcGetMixContractListRsp(String reqId) {
		RpcGetMixContractListRsp rpcGetMixContractListRsp = rpcGetMixContractListRspMap.remove(reqId);
	...
	@Override
	public void onGetMixContractListRsp(RpcGetMixContractListRsp rpcGetMixContractListRsp) {
		String reqId = rpcGetMixContractListRsp.getCommonRsp().getReqId();
		if (waitReqIdSet.contains(reqId)) {
			rpcGetMixContractListRspMap.put(reqId, rpcGetMixContractListRsp);
		} else {
			logger.info("直接丢弃的回报,请求ID:{}", reqId);
		}
	}
	...
	@Override
	public void onQueryDBBarListRsp(RpcQueryDBBarListRsp rpcQueryDBBarListRsp) {
		String reqId = rpcQueryDBBarListRsp.getCommonRsp().getReqId();
		if (waitReqIdSet.contains(reqId)) {
			rpcQueryDBBarListRspMap.put(reqId, rpcQueryDBBarListRsp);
		} else {
			logger.info("直接丢弃的回报,请求ID:{}", reqId);
		}
	}
	...
	@Override
	public void onQueryDBTickListRsp(RpcQueryDBTickListRsp rpcQueryDBTickListRsp) {
		String reqId = rpcQueryDBTickListRsp.getCommonRsp().getReqId();
		if (waitReqIdSet.contains(reqId)) {
			rpcQueryDBTickListRspMap.put(reqId, rpcQueryDBTickListRsp);
		} else {
			logger.info("直接丢弃的回报,请求ID:{}", reqId);
		}
	}
	...
	@Override
	public void onQueryVolumeBarListRsp(RpcQueryVolumeBarListRsp rpcQueryVolumeBarListRsp) {
		String reqId = rpcQueryVolumeBarListRsp.getCommonRsp().getReqId();
		if (waitReqIdSet.contains(reqId)) {
			rpcQueryVolumeBarListRspMap.put(reqId, rpcQueryVolumeBarListRsp);
		} else {
			logger.info("直接丢弃的回报,请求ID:{}", reqId);
		}
	}
