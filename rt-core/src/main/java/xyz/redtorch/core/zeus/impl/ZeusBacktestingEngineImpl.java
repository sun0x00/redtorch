...
public class ZeusBacktestingEngineImpl implements ZeusBacktestingEngine {
	...
	public ZeusBacktestingEngineImpl(ZeusDataService zeusDataService, StrategySetting strategySetting,
		...
		this.backtestingOutputDir = backtestingOutputDir;
	...
	public List<Bar> loadBacktestingBarDataList(String startDate, String endDate, List<String> subscribeRtSymbolList) {
		...
		for (String rtSymbol : subscribeRtSymbolList) {
			List<Bar> tmpBarList = zeusDataService.loadBarDataList(startDateTime, endDateTime, rtSymbol);
	...
	public List<Tick> loadBacktestingTickDataList(String startDate, String endDate,
		...
		for (String rtSymbol : subscribeRtSymbolList) {
			tickList.addAll(zeusDataService.loadTickDataList(startDateTime, endDateTime, rtSymbol));
		}
