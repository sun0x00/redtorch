...
import xyz.redtorch.api.jctp.trader.CThostFtdcAccountregisterField;
import xyz.redtorch.api.jctp.trader.CThostFtdcBatchOrderActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcBrokerTradingAlgosField;
import xyz.redtorch.api.jctp.trader.CThostFtdcBrokerTradingParamsField;
import xyz.redtorch.api.jctp.trader.CThostFtdcBulletinField;
import xyz.redtorch.api.jctp.trader.CThostFtdcCFMMCTradingAccountKeyField;
import xyz.redtorch.api.jctp.trader.CThostFtdcCFMMCTradingAccountTokenField;
import xyz.redtorch.api.jctp.trader.CThostFtdcCancelAccountField;
import xyz.redtorch.api.jctp.trader.CThostFtdcChangeAccountField;
import xyz.redtorch.api.jctp.trader.CThostFtdcCombActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcCombInstrumentGuardField;
import xyz.redtorch.api.jctp.trader.CThostFtdcContractBankField;
import xyz.redtorch.api.jctp.trader.CThostFtdcDepthMarketDataField;
import xyz.redtorch.api.jctp.trader.CThostFtdcEWarrantOffsetField;
import xyz.redtorch.api.jctp.trader.CThostFtdcErrorConditionalOrderField;
import xyz.redtorch.api.jctp.trader.CThostFtdcExchangeField;
import xyz.redtorch.api.jctp.trader.CThostFtdcExchangeMarginRateAdjustField;
import xyz.redtorch.api.jctp.trader.CThostFtdcExchangeMarginRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcExchangeRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcExecOrderActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcExecOrderField;
import xyz.redtorch.api.jctp.trader.CThostFtdcForQuoteField;
import xyz.redtorch.api.jctp.trader.CThostFtdcForQuoteRspField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputBatchOrderActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputCombActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputExecOrderActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputExecOrderField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputForQuoteField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputOptionSelfCloseActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputOptionSelfCloseField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputOrderActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputOrderField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputQuoteActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInputQuoteField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInstrumentCommissionRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInstrumentField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInstrumentMarginRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInstrumentOrderCommRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInstrumentStatusField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInvestUnitField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInvestorField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInvestorPositionCombineDetailField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInvestorPositionDetailField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInvestorPositionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcInvestorProductGroupMarginField;
import xyz.redtorch.api.jctp.trader.CThostFtdcMMInstrumentCommissionRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcMMOptionInstrCommRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcNoticeField;
import xyz.redtorch.api.jctp.trader.CThostFtdcNotifyQueryAccountField;
import xyz.redtorch.api.jctp.trader.CThostFtdcOpenAccountField;
import xyz.redtorch.api.jctp.trader.CThostFtdcOptionInstrCommRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcOptionInstrTradeCostField;
import xyz.redtorch.api.jctp.trader.CThostFtdcOptionSelfCloseActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcOptionSelfCloseField;
import xyz.redtorch.api.jctp.trader.CThostFtdcOrderActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcOrderField;
import xyz.redtorch.api.jctp.trader.CThostFtdcParkedOrderActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcParkedOrderField;
import xyz.redtorch.api.jctp.trader.CThostFtdcProductExchRateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcProductField;
import xyz.redtorch.api.jctp.trader.CThostFtdcProductGroupField;
import xyz.redtorch.api.jctp.trader.CThostFtdcQryInstrumentField;
import xyz.redtorch.api.jctp.trader.CThostFtdcQryInvestorPositionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcQryTradingAccountField;
import xyz.redtorch.api.jctp.trader.CThostFtdcQueryCFMMCTradingAccountTokenField;
import xyz.redtorch.api.jctp.trader.CThostFtdcQueryMaxOrderVolumeField;
import xyz.redtorch.api.jctp.trader.CThostFtdcQuoteActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcQuoteField;
import xyz.redtorch.api.jctp.trader.CThostFtdcRemoveParkedOrderActionField;
import xyz.redtorch.api.jctp.trader.CThostFtdcRemoveParkedOrderField;
import xyz.redtorch.api.jctp.trader.CThostFtdcReqAuthenticateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcReqQueryAccountField;
import xyz.redtorch.api.jctp.trader.CThostFtdcReqRepealField;
import xyz.redtorch.api.jctp.trader.CThostFtdcReqTransferField;
import xyz.redtorch.api.jctp.trader.CThostFtdcReqUserLoginField;
import xyz.redtorch.api.jctp.trader.CThostFtdcRspAuthenticateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcRspInfoField;
import xyz.redtorch.api.jctp.trader.CThostFtdcRspRepealField;
import xyz.redtorch.api.jctp.trader.CThostFtdcRspTransferField;
import xyz.redtorch.api.jctp.trader.CThostFtdcRspUserLoginField;
import xyz.redtorch.api.jctp.trader.CThostFtdcSecAgentACIDMapField;
import xyz.redtorch.api.jctp.trader.CThostFtdcSecAgentCheckModeField;
import xyz.redtorch.api.jctp.trader.CThostFtdcSettlementInfoConfirmField;
import xyz.redtorch.api.jctp.trader.CThostFtdcSettlementInfoField;
import xyz.redtorch.api.jctp.trader.CThostFtdcTradeField;
import xyz.redtorch.api.jctp.trader.CThostFtdcTraderApi;
import xyz.redtorch.api.jctp.trader.CThostFtdcTraderSpi;
import xyz.redtorch.api.jctp.trader.CThostFtdcTradingAccountField;
import xyz.redtorch.api.jctp.trader.CThostFtdcTradingAccountPasswordUpdateField;
import xyz.redtorch.api.jctp.trader.CThostFtdcTradingCodeField;
import xyz.redtorch.api.jctp.trader.CThostFtdcTradingNoticeField;
import xyz.redtorch.api.jctp.trader.CThostFtdcTradingNoticeInfoField;
import xyz.redtorch.api.jctp.trader.CThostFtdcTransferBankField;
import xyz.redtorch.api.jctp.trader.CThostFtdcTransferSerialField;
import xyz.redtorch.api.jctp.trader.CThostFtdcUserLogoutField;
import xyz.redtorch.api.jctp.trader.CThostFtdcUserPasswordUpdateField;
...
public class TdSpi extends CThostFtdcTraderSpi {
	...
	public String sendOrder(OrderReq orderReq) {
		...
		cThostFtdcInputOrderField.setOrderPriceType(CtpConstant.priceTypeMap.getOrDefault(orderReq.getPriceType(),Character.valueOf('\0')));
		cThostFtdcInputOrderField.setDirection(CtpConstant.directionMap.getOrDefault(orderReq.getDirection(),Character.valueOf('\0')));
		cThostFtdcInputOrderField.setCombOffsetFlag(String.valueOf(CtpConstant.offsetMap.getOrDefault(orderReq.getOffset(),Character.valueOf('\0'))));
		...
		cThostFtdcInputOrderField.setCombHedgeFlag(String.valueOf(jctptraderapiv6v3v11x64Constants.THOST_FTDC_HF_Speculation));
	...
	public void OnRspOrderInsert(CThostFtdcInputOrderField pInputOrder, CThostFtdcRspInfoField pRspInfo, int nRequestID,
		...
		order.setSymbol(pInputOrder.getInstrumentID());
		order.setExchange(CtpConstant.exchangeMapReverse.get(pInputOrder.getExchangeID()));
		order.setRtSymbol(pInputOrder.getInstrumentID() + "." + pInputOrder.getExchangeID());
		order.setOrderID(pInputOrder.getOrderRef());
		order.setRtOrderID(gatewayID + "." + pInputOrder.getOrderRef());
		order.setDirection(
				CtpConstant.directionMapReverse.getOrDefault(pInputOrder.getDirection(), RtConstant.DIRECTION_UNKNOWN));
		order.setOffset(
				CtpConstant.offsetMapReverse.getOrDefault(pInputOrder.getCombOffsetFlag(), RtConstant.OFFSET_UNKNOWN));
		order.setStatus(RtConstant.STATUS_REJECTED);
		order.setPrice(pInputOrder.getLimitPrice());
		order.setTotalVolume(pInputOrder.getVolumeTotalOriginal());

		// 发送委托事件
		ctpGateway.emitOrder(order);
		String logContent = MessageFormat.format("{0}交易接口发单错误回报(柜台)! ErrorID:{1},ErrorMsg:{2}", gatewayLogInfo, pRspInfo.getErrorID(),pRspInfo.getErrorMsg());
		log.error(logContent);
		ctpGateway.emitErrorLog(logContent);
	...
	public void OnRspSettlementInfoConfirm(CThostFtdcSettlementInfoConfirmField pSettlementInfoConfirm,
		...
		if (pRspInfo.getErrorID() == 0) {
			String logContent = MessageFormat.format("{0}交易接口结算信息确认完成!", gatewayLogInfo,
					pRspInfo.getErrorID(), pRspInfo.getErrorMsg());
			ctpGateway.emitWarnLog(logContent);
			log.warn(logContent);
	...
	public void OnRspQryInstrument(CThostFtdcInstrumentField pInstrument, CThostFtdcRspInfoField pRspInfo,
		...
		contract.setProductClass(CtpConstant.productClassMapReverse.getOrDefault(pInstrument.getProductClass(), RtConstant.PRODUCT_UNKNOWN));
	...
	public void OnRtnOrder(CThostFtdcOrderField pOrder) {
		...
		Order order = new Order();
		order.setGatewayID(gatewayID);
		order.setSymbol(pOrder.getInstrumentID());
		order.setExchange(CtpConstant.exchangeMapReverse.get(pOrder.getExchangeID()));
		order.setRtSymbol(order.getSymbol()+"."+order.getExchange());
		
		order.setOrderID(pOrder.getOrderRef());
		...
		order.setDirection(CtpConstant.directionMapReverse.get(pOrder.getDirection()));
		order.setOffset(CtpConstant.offsetMapReverse.get(pOrder.getCombOffsetFlag().toCharArray()[0]));
		order.setStatus(CtpConstant.statusMapReverse.get(pOrder.getOrderStatus()));
		
		order.setPrice(pOrder.getLimitPrice());
		order.setTotalVolume(pOrder.getVolumeTotalOriginal());
		order.setTradedVolume(pOrder.getVolumeTraded());
		order.setOrderDate(pOrder.getInsertDate());
		order.setOrderTime(pOrder.getInsertTime());
		order.setCancelTime(pOrder.getCancelTime());
		order.setUpdateTime(pOrder.getUpdateTime());
		order.setActiveTime(pOrder.getActiveTime());
		
		order.setFrontID(pOrder.getFrontID());
		order.setSessionID(pOrder.getSessionID());
	...
	public void OnErrRtnOrderInsert(CThostFtdcInputOrderField pInputOrder, CThostFtdcRspInfoField pRspInfo) {
		...
		order.setDirection(CtpConstant.directionMapReverse.get(pInputOrder.getDirection()));
		order.setOffset(CtpConstant.offsetMapReverse.get(pInputOrder.getCombOffsetFlag().toCharArray()[0]));
		order.setStatus(RtConstant.STATUS_REJECTED);
		...
		ctpGateway.emitOrder(order);
		String logContent = MessageFormat.format("{0}交易接口发单错误回报（交易所）! ErrorID:{1},ErrorMsg:{2}", gatewayLogInfo, pRspInfo.getErrorID(),pRspInfo.getErrorMsg());
		log.error(logContent);
		ctpGateway.emitErrorLog(logContent);
	...
	public void OnErrRtnOrderAction(CThostFtdcOrderActionField pOrderAction, CThostFtdcRspInfoField pRspInfo) {
		String logContent = MessageFormat.format("{0}交易接口撤单错误回报（交易所）! ErrorID:{1},ErrorMsg:{2}", gatewayLogInfo, pRspInfo.getErrorID(),pRspInfo.getErrorMsg());
		log.error(logContent);
		ctpGateway.emitErrorLog(logContent);
	}
