...
public interface MasterTradeCachesService {
	...
	void cacheOrderList(List<OrderField> orderList, int sourceNodeId);

	void cacheTradeList(List<TradeField> tradeList, int sourceNodeId);

	void cacheContractList(List<ContractField> contractList, int sourceNodeId);

	void cachePositionList(List<PositionField> positionList, int sourceNodeId);

	void cacheAccountList(List<AccountField> accountList, int sourceNodeId);

	void cacheTickList(List<TickField> tickList, int sourceNodeId);
