...
public class NodeController {
	...
	@ResponseBody
	public ResponseVo<String> deleteNodeByNodeId(HttpServletRequest request,
			@RequestBody RequestVo<Integer> requestVo) {
	...
	@ResponseBody
	public ResponseVo<String> resetNodeTokenByNodeId(HttpServletRequest request,
			@RequestBody RequestVo<Integer> requestVo) {
		ResponseVo<String> responseVo = new ResponseVo<>();
		try {
			UserPo user = (UserPo) request.getSession().getAttribute(RtConstant.KEY_USER_PO);
