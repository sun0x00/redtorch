...
public class WebSockeServerHandshakeInterceptor extends HttpSessionHandshakeInterceptor {
	...
	private final static Logger logger = LoggerFactory.getLogger(WebSockeServerHandshakeInterceptor.class);
	...
	public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response, WebSocketHandler wsHandler,
		...
		if (request instanceof ServletServerHttpRequest) {
			...
			try {
				...
				if (!StringUtils.isBlank(skipTradeEvents) && skipTradeEvents.equals("true")) {
