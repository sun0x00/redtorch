...
public class SlaveTradeExecuteServiceImpl implements SlaveTradeExecuteService {
    ...
    private final Map<String, SubmitOrderReqField> submitOrderReqMap = new ConcurrentHashMap<>(5000);
    private final Map<String, String> originOrderIdToOrderIdMap = new ConcurrentHashMap<>(5000);
    private final Map<String, String> orderIdToOriginOrderIdMap = new ConcurrentHashMap<>(5000);
