	...
	static {
		...
		try {
			if (System.getProperties().getProperty("os.name").toUpperCase().indexOf("WINDOWS") != -1) {
				...
				tempLibPath = envTmpDir + File.separator + "xyz" + File.separator + "redtorch" + File.separator
						+ "api" + File.separator + "jctp" + File.separator + "lib" + File.separator + "jctpv6v3v11x64api" + File.separator  ; 
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v11x64api/thostmduserapi.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v11x64api/thosttraderapi.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v11x64api/jctpv6v3v11x64api.dll"));
			} else {
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v11x64api/libthostmduserapi.so"));
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v11x64api/libthosttraderapi.so"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v11x64api/libjctpv6v3v11x64api.so"));
			}
		} catch (Exception e) {
		...
		try {
			if (System.getProperties().getProperty("os.name").toUpperCase().indexOf("WINDOWS") != -1) {
				...
				System.load(tempLibPath + File.separator + "jctpv6v3v11x64api.dll");
			} else {
				System.load(tempLibPath + File.separator + "libthostmduserapi.so");
				System.load(tempLibPath + File.separator + "libthosttraderapi.so");
				System.load(tempLibPath + File.separator + "libjctpv6v3v11x64api.so");
			}
		} catch (Exception e) {
