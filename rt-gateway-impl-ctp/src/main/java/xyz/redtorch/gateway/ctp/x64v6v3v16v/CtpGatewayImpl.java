		...
		try {
			if (System.getProperties().getProperty("os.name").toUpperCase().indexOf("WINDOWS") != -1) {
				...
				tempLibPath = envTmpDir + File.separator + "xyz" + File.separator + "redtorch" + File.separator
						+ "api" + File.separator + "jctp" + File.separator + "lib" + File.separator + "jctpv6v3v16x64api" + File.separator  ; 
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v16x64api/thostmduserapi.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v16x64api/thosttraderapi.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v16x64api/jctpv6v3v16x64api.dll"));
			} else {
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v16x64api/libjctpv6v3v16x64api.so"));
			}
		} catch (Exception e) {
