	...
	static {
		...
		try {
			if (System.getProperties().getProperty("os.name").toUpperCase().contains("WINDOWS")) {
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v5v1cpx64api/thostmduserapi_se.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v5v1cpx64api/thosttraderapi_se.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v5v1cpx64api/jctpv6v5v1cpx64api.dll"));
			} else {
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v5v1cpx64api/libthostmduserapi_se.so"));
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v5v1cpx64api/libthosttraderapi_se.so"));
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v5v1cpx64api/libjctpv6v5v1cpx64api.so"));
			}
		} catch (Exception e) {
