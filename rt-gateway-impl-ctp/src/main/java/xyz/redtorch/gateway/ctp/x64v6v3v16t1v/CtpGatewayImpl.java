		...
		try {
			if (System.getProperties().getProperty("os.name").toUpperCase().indexOf("WINDOWS") != -1) {
				...
				tempLibPath = envTmpDir + File.separator + "xyz" + File.separator + "redtorch" + File.separator
						+ "api" + File.separator + "jctp" + File.separator + "lib" + File.separator + "jctpv6v3v16t1x64api" + File.separator  ; 
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v16t1x64api/thostmduserapi_se.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v16t1x64api/thosttraderapi_se.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v16t1x64api/jctpv6v3v16t1x64api.dll"));
			} else {
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v16t1x64api/libjctpv6v3v16t1x64api.so"));
			}
		} catch (Exception e) {
