	...
	static {
		...
		try {
			if (System.getProperties().getProperty("os.name").toUpperCase().indexOf("WINDOWS") != -1) {
				...
				tempLibPath = envTmpDir + File.separator + "xyz" + File.separator + "redtorch" + File.separator
						+ "api" + File.separator + "jctp" + File.separator + "lib" + File.separator + "jctpv6v3v13x64api" + File.separator  ; 
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v13x64api/thostmduserapi_se.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v13x64api/thosttraderapi_se.dll"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v13x64api/jctpv6v3v13x64api.dll"));
			} else {
				...
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v13x64api/libthostmduserapi_se.so"));
				CommonUtils.copyURLToFileForTmp(tempLibPath, CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v13x64api/libthosttraderapi_se.so"));
				CommonUtils.copyURLToFileForTmp(tempLibPath,
						CtpGatewayImpl.class.getResource("/assembly/jctpv6v3v13x64api/libjctpv6v3v13x64api.so"));
			}
		} catch (Exception e) {
		...
		try {
			if (System.getProperties().getProperty("os.name").toUpperCase().indexOf("WINDOWS") != -1) {
				...
				System.load(tempLibPath + File.separator + "jctpv6v3v13x64api.dll");
			} else {
				...
				System.load(tempLibPath + File.separator + "libjctpv6v3v13x64api.so");
			}
		} catch (Exception e) {
