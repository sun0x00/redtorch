...
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcDepthMarketDataField;
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcForQuoteRspField;
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcMdApi;
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcMdSpi;
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcReqUserLoginField;
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcRspInfoField;
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcRspUserLoginField;
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcSpecificInstrumentField;
import xyz.redtorch.gateway.ctp.x64v6v3v19p1v.api.CThostFtdcUserLogoutField;
...
public class MdSpi extends CThostFtdcMdSpi {
	...
	public void connect() {
		...
		String tempFilePath = envTmpDir + File.separator + "xyz" + File.separator + "redtorch" + File.separator + "gateway" + File.separator + "ctp" + File.separator + "jctpv6v3v19p1x64api"
