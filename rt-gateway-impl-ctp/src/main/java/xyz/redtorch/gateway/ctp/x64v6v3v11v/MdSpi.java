...
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcDepthMarketDataField;
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcForQuoteRspField;
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcMdApi;
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcMdSpi;
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcReqUserLoginField;
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcRspInfoField;
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcRspUserLoginField;
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcSpecificInstrumentField;
import xyz.redtorch.gateway.ctp.x64v6v3v11v.api.CThostFtdcUserLogoutField;
	...
	public synchronized void connect() {
		...
		try {
			...
			String tempFilePath = envTmpDir + File.separator + "xyz" + File.separator + "redtorch" + File.separator
					+ "gateway" + File.separator + "ctp" + File.separator + "jctpv6v3v11x64api" + File.separator
