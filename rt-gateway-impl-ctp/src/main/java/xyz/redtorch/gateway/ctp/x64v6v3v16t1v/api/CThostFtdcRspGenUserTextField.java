...
public class CThostFtdcRspGenUserTextField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v3v16t1x64apiJNI.delete_CThostFtdcRspGenUserTextField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setUserTextSeq(int value) {
    jctpv6v3v16t1x64apiJNI.CThostFtdcRspGenUserTextField_UserTextSeq_set(swigCPtr, this, value);
  }

  public int getUserTextSeq() {
    return jctpv6v3v16t1x64apiJNI.CThostFtdcRspGenUserTextField_UserTextSeq_get(swigCPtr, this);
  }

  public CThostFtdcRspGenUserTextField() {
    this(jctpv6v3v16t1x64apiJNI.new_CThostFtdcRspGenUserTextField(), true);
  }
