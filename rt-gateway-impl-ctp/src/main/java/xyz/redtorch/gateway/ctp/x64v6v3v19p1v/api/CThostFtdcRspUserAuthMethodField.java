...
public class CThostFtdcRspUserAuthMethodField {
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        jctpv6v3v19p1x64apiJNI.delete_CThostFtdcRspUserAuthMethodField(swigCPtr);
      }
      swigCPtr = 0;
    }
  }
  ...
  public void setUsableAuthMethod(int value) {
    jctpv6v3v19p1x64apiJNI.CThostFtdcRspUserAuthMethodField_UsableAuthMethod_set(swigCPtr, this, value);
  }

  public int getUsableAuthMethod() {
    return jctpv6v3v19p1x64apiJNI.CThostFtdcRspUserAuthMethodField_UsableAuthMethod_get(swigCPtr, this);
  }

  public CThostFtdcRspUserAuthMethodField() {
    this(jctpv6v3v19p1x64apiJNI.new_CThostFtdcRspUserAuthMethodField(), true);
  }
