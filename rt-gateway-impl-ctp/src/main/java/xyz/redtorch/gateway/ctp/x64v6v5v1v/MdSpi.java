...
import xyz.redtorch.gateway.ctp.x64v6v5v1v.api.*;
...
public class MdSpi extends CThostFtdcMdSpi {
    ...
    public void connect() {
        ...
        String tempFilePath = envTmpDir + File.separator + "xyz" + File.separator + "redtorch" + File.separator + "gateway" + File.separator + "ctp" + File.separator + "jctpv6v5v1x64api"
    ...
    public void OnRspUserLogin(CThostFtdcRspUserLoginField pRspUserLogin, CThostFtdcRspInfoField pRspInfo, int nRequestID, boolean bIsLast) {
        try {
            if (pRspInfo.getErrorID() == 0) {
                ...
                if(StringUtils.isNotBlank(pRspUserLogin.getTradingDay())){
                    tradingDay = Integer.parseInt(pRspUserLogin.getTradingDay());
                }
    ...
    public void OnRtnDepthMarketData(CThostFtdcDepthMarketDataField pDepthMarketData) {
        if (pDepthMarketData != null) {
            try {
                ...
                int actionDayInt = Integer.parseInt(actionDay);

                String updateDateTimeWithMS = ((long)actionDayInt * 1000000 * 1000 + updateTime * 1000 + updateMillisec) + "";
...
//				}
                ...
                int actionTimeInt = Integer.parseInt(dateTime.format(CommonConstant.T_FORMAT_WITH_MS_INT_FORMATTER));
                ...
                tickBuilder.setActionDay(actionDayInt);
                tickBuilder.setActionTime(actionTimeInt);
